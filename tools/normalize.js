...
d = d.sort((a_, b_) => {
  ...
  return a > b ? 1 : -1;
}).map(({toaq, type, english, gloss, keywords, frame, distribution, namesake, notes, examples, fields}) =>
       ({toaq, type, english, gloss, keywords, frame, distribution, namesake, notes, examples, fields}));
d.forEach(e => {
